                        ...
                        <CardContent className="space-y-4">
                            <div className="flex flex-col items-center">
                                <Avatar className="h-20 w-20">
                                    <AvatarFallback className="bg-[#343264] text-4xl text-gray-100">SO</AvatarFallback>
                                </Avatar>
                        ...
                        <CardContent>
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Input id="last" placeholder="Doe" className="text-gray-500 border-gray-800" />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <Label htmlFor="email" className="text-gray-900">{t('profile.personal.email')}</Label>
                                    <Input id="email" type="email" placeholder="officer@security.com" className="text-gray-500 border-gray-800" />
                                </div>
                            </div>
