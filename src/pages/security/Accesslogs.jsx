      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-4">
          ...
          <CardContent className="p-4 space-y-4">
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input
                  placeholder="Search student, device, or serial number..."
                  value={searchQuery}
        ...
        <Card className="border border-gray-200 shadow-sm overflow-hidden">
            <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-gray-50 border-b border-gray-200 font-semibold text-sm text-gray-700">
              ...
              <div className="col-span-2">Date/Time</div>image.png
                                        ...
                                        <div className="bg-slate-50 px-6 py-4 border-b border-gray-100 text-sm">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <p><span className="text-gray-500">ID:</span> {log.id}</p>
                                                    <p><span className="text-gray-500">Full Time:</span> {new Date(log.timestamp).toLocaleString()}</p>
                                                </div>
                                                <div>
                                                    <h4 className="font-semibold text-gray-900 mb-2">Notes / Purpose</h4>
                                            ...
                                            <div className="mt-4 flex justify-end">
                                                ...
                                                >
                                                    <ExternalLink className="h-3 w-3 mr-2" /> View Device History
                                                </Button>
                                            </div>
                                        </div>
                                    )}
