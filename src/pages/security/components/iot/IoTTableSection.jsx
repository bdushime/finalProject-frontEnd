            ...
            <Table>
              ...
              <TableBody>
                {currentTrackers.map((tracker) => (
                  ...
                  >
                    <TableCell className="font-medium">{tracker.equipment}</TableCell>
                    <TableCell>
                      <code className="text-xs bg-muted px-2 py-1 rounded">{tracker.id}</code>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2 min-w-[120px]">
                        ...
                        <div className="flex-1">
                          ...
                          <span className="text-xs text-muted-foreground">{tracker.battery}%</span>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-1">
                        <Thermometer
                          className={`h-4 w-4 ${getTemperatureColor(tracker.temperature)}`}
                        />
              ...
              <div className="pt-2 border-t border-border">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-2xl">
                    <DialogHeader>
                      <DialogTitle>{t("iot.table.historyTitle", { equipment: tracker.equipment })}</DialogTitle>
                      <DialogDescription>
                        {tracker.id} • {tracker.location}
                      </DialogDescription>
                    </DialogHeader>
                    <TrackerHistoryChart data={historyData[tracker.id] || []} tracker={tracker} />
                  </DialogContent>
                </Dialog>
              </div>
            </CardContent>
...
export function TrackerHistoryDialog({ selectedTracker, onClose, historyData }) {
  const { t } = useTranslation(["itstaff"]);
...
function TrackerHistoryChart({ data, tracker }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h4 className="text-sm font-medium mb-2">{t("iot.table.trends")}</h4>
