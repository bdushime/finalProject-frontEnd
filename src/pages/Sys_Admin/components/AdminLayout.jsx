...
import { Search, Bell, User, Menu, X, LayoutDashboard, Users, Settings, Database, Activity, FileText, Shield, LogOut, BookOpen, School } from 'lucide-react';
...
const AdminLayout = ({ children, heroContent }) => {
  ...
  const navItems = [
    ...
    { label: t("nav.classrooms", "Classrooms"), href: '/admin/classrooms', icon: School },
