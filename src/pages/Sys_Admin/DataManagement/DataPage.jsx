            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div><h2 className="text-xl font-bold text-slate-900">Database Backups</h2></div>
                    </div>
                        ...
                        <div className="space-y-4 flex-grow">
                            ...
                            <div onClick={() => handleExport('equipment')} className="p-4 border border-gray-100 rounded-xl hover:border-[#8D8DC7]/30 transition-colors cursor-pointer flex justify-between items-center group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-semibold text-slate-800">Equipment Data</p>
                                        <p className="text-xs text-gray-500">Inventory status & details</p>
                                    </div>
                                </div>
                                <button className="px-3 py-1.5 bg-gray-100 text-gray-600 text-sm font-medium rounded-lg">CSV</button>
                            </div>
                            ...
                            <div onClick={() => handleExport('users')} className="p-4 border border-gray-100 rounded-xl hover:border-[#8D8DC7]/30 transition-colors cursor-pointer flex justify-between items-center group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500">Profiles & roles</p>
                                    </div>
                                </div>
                                <button className="px-3 py-1.5 bg-gray-100 text-gray-600 text-sm font-medium rounded-lg">CSV</button>
                            </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="p-4 border border-gray-100 rounded-2xl hover:bg-red-50/30 transition-colors">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-800">Clear Old Logs</h4>
                                    <p className="text-xs text-gray-500 mb-3">Remove transactions older than 90 days.</p>
                                    <button onClick={handleCleanup} className="text-xs font-bold text-red-500 hover:underline">Execute Cleanup</button>
                                </div>
                            </div>
                        </div>
                    </div>
