                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="xl:col-span-2 bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                <h3 className="text-lg font-bold text-slate-900">{t('monitoring.charts.performance')}</h3>
                                <p className="text-sm text-gray-400">{t('monitoring.charts.perfDesc')}</p>
                            </div>
                            <div className="flex gap-4 text-xs font-bold text-gray-500">
                                <div className="flex items-center gap-1">
                                    <div className="w-3 h-1 bg-[#8D8DC7] rounded-full"></div> {t('monitoring.charts.cpu')}
                                </div>
                                <div className="flex items-center gap-1">
                                    <div className="w-3 h-1 bg-indigo-200 rounded-full"></div> {t('monitoring.charts.memory')}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-800 text-white">
                        <h3 className="text-lg font-bold mb-4">{t('monitoring.servers.title')}</h3>
