...
import { equipmentData, categories, Equipment } from '@components/lib/equipmentData';
...
export function BrowseEquipment({ onViewDetails, onCheckout, onSearch }: BrowseEquipmentProps) {
              ...
              <Card key={equipment.id} className="flex flex-col">
                <CardHeader>
                  <div className="flex items-start justify-between mb-2">
                    <CategoryBadge category={equipment.category as any} />
