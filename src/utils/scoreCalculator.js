 ...
 */
export function calculateNewScore(currentScore, change) {
 ...
 */
export function getMaxCheckoutDays(score) {
 ...
 */
export function canMakeReservations(score) {
 ...
 */
export function canCheckoutEquipment(score, equipmentValue) {
  const level = getScoreLevel(score).level
 ...
 */
export function getUserPrivileges(score) {
  const level = getScoreLevel(score).level
