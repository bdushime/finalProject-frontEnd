...
MenubarSeparator.propTypes = { className: PropTypes.string };
...
MenubarShortcut.propTypes = { className: PropTypes.string };
...
MenubarSubContent.propTypes = { className: PropTypes.string };
