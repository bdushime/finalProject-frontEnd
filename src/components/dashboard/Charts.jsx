                ...
                <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={activityTrendsData}>
                            ...
                            <Tooltip contentStyle={{ backgroundColor: COLORS.background, border: "1px solid border", borderRadius: "0.5rem" }} />
                            <Legend />
                            <Line type="monotone" dataKey="checkouts" stroke={COLORS.blue} strokeWidth={2} name="Checkouts" dot={{ r: 4 }} />
                            <Line type="monotone" dataKey="returns" stroke={COLORS.green} strokeWidth={2} name="Returns" dot={{ r: 4 }} />
                        </LineChart>
                    </ResponsiveContainer>
                </CardContent>
            </Card>
                ...
                <CardContent>
                    <ResponsiveContainer width="100%" height={400}>
                        <BarChart data={deviceTypesData}>
                            ...
                            <XAxis dataKey="name" className="text-xs" tick={{ fill: "currentColor" }} />
                            <YAxis className="text-xs" tick={{ fill: "currentColor" }} />
                            <Tooltip contentStyle={{ backgroundColor: "bg-[#343264]", border: "1px solid var(--border)", borderRadius: "0.5rem" }} />
