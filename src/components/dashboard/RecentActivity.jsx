  ...
  return (
    <div className="flex flex-col justify-between p-4 h-full">
      ...
      <div className="flex items-baseline justify-between text-gray-900 mb-4">
        <div className="text-lg font-bold">Device Usage</div>
      ...
      <p className="text-xs text-slate-500 mb-4">
        {activeLoans} out of {totalDevices} devices currently in use.
      </p>
          ...
          {activities.length === 0 ? (
            ...
            activities.map((activity) => (
              ...
              >
                ...
                <div
                  className={`flex h-6 w-6 items-center justify-center rounded-full border shrink-0 ${
                    activity.returned
